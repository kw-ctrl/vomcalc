...
async function updateHeaderAuth(authState) {
    ...
    if (!user) {
        ...
        container.innerHTML = `
            <button id="headerSignIn" style="padding:8px 18px;background:#00e5a0;color:#000;font-size:12px;font-weight:700;border:none;border-radius:8px;cursor:pointer;letter-spacing:0.01em;transition:background 0.15s" onmouseover="this.style.background='#00ffb3'" onmouseout="this.style.background='#00e5a0'">
                Sign Up Free
            </button>
        `;
